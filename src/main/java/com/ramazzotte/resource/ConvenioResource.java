...
//	public ResponseEntity<?> findAll(ConvenioFilter convenioFilter, Pageable pageable) {
//		Page<Convenio> clis = repo.filtrar(muralFilter, pageable, usu);
//		Page<ConvenioFlat> list = service.mudarConvenioParaFlat(clis);
